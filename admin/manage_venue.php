        ...
        <div class="card">
            <div class="card-body">
                <form action="" id="manage-venue">
                    ...
                    <div class="form-group row">
                        <div class="col-md-5">
                            <label for="" class="control-label">Max Capacity</label>
                            <input type="number" class="form-control text-right" name="max_capacity" value="<?php echo isset($max_capacity) ? $max_capacity : 0; ?>" required>
                        </div>
                    </div>

					<!-- venue images upload function -->
...
<script>
	...
	// sending request to admin_class to save/update the venue
	...
	// for browsers' compability for drag and drop
	...
	// preview the uploaded images before submission
    ...
    function rem_func($this) {
        $this.closest('.imgF').remove();
    }
</script>
